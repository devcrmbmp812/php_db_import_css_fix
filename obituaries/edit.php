...
$page = 'obituaries';
$meta_subtitle = ' | Edit a Remembrance'; 
...
<div id="create_listing" class="container">
	<div class="double-stripe"><span class="listing_header">Edit a Remembrance</span></div>
    <?
	if( $_REQUEST['error'] ) {
    ...
    <form action="/admin/index.php" enctype="multipart/form-data" id="create_obit" method="post">
        ...
        <input type="hidden" name="proc_type" value="update">
        ...
        <div class="button_row">
            ...
            if( $obituary->obituary['approvedOn'] ) {
                ?><input type="submit" id="submit" class="btn btn-primary obit-btn-lrg button pull-right" name="submit" value="SAVE UPDATES"><?
            } else {
                ?><input type="submit" id="submit" class="btn btn-primary obit-btn-lrg button pull-right" name="submit" value="SUBMIT FOR APPROVAL"><?
            }
            ?>
